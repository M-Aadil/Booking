      ...
      >
        {/* <div className="headerList">
          ...
          <div className="headerListItem hotels">
            ...
            <p style={{ cursor: 'pointer' }} onClick={handleSearch} >Hotels</p>
          </div>
        ...
        {type !== "list" && (
          <>
            <h1 className="headerTitle" style={{marginTop:"39px"}}>
              A lifetime of discounts? It's Genius.
            </h1>
            <p className="headerDesc">
              Get rewarded for your travels – unlock instant savings of 10% or
              more with a free ebooking account
            </p>
            {/* {!user && <button className="headerBtn">Login in / Sign in</button>} */}
